  ...
  <footer>
    <div class="container">
      <div class="footer__info">
        <div class="footer__contacts">
          <div class="footer__contacts-column">
            ...
            <div v-if="siteInfo.address" class="footer__contacts-item address">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="footer__contacts-column">
            <a target="_blank" v-if="siteInfo.vk" :href="'https://vk.me/' + siteInfo.vk" class="footer__contacts-item">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a target="_blank" v-if="siteInfo.telegram" :href="'https://t.me/' + siteInfo.telegram" class="footer__contacts-item">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a target="_blank" v-if="siteInfo.whatsapp" :href="'https://api.whatsapp.com/send?phone=' + siteInfo.phone" class="footer__contacts-item">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="footer__organization">
        <div v-show="siteInfo.organization_name">{{ siteInfo.organization_name }}</div>
        <div v-show="siteInfo.inn">{{ "ИНН: " + siteInfo.inn  }}</div>
        <div v-show="siteInfo.kpp">{{ "КПП: " + siteInfo.kpp }}</div>
        <div v-show="siteInfo.ogrn">{{ "ОГРН: " + siteInfo.ogrn }}</div>
        <div v-show="siteInfo.ogrnip">{{  "ОГРНИП: " + siteInfo.ogrnip}}</div>
      </div>
