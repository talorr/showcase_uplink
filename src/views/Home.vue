...
useHead({
  title: "Доставка цветов в Томске | ПРОЦВЕТАЙ",
  meta: [
    {
      name: 'description',
      content: 'Заказать цветы с доставкой на дом в Томске . ✔ Свежие цветы с гарантией качества, ✔ онлайн-оплата, ✔ скидки и бонусы ✔ быстрая доставка от салона «ПРОЦВЕТАЙ». Оформите заказ на сайте или по телефону ☎ 89526792900'
    },
    {
      name: 'keywords',
